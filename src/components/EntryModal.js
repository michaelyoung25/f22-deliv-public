...
export default function EntryModal({ entry, type, user }) {
   ...
   const handleUpdate = () => {
      if (locked) {
         ...
         updateEntry(updatedEntry, entry.id).catch(console.error);
         handleClose();
      }
   }
   ...
   const openButton =
      type === "edit" ? <IconButton onClick={handleClickEdit}>
         <OpenInNewIcon />
      </IconButton>
         : type === "add" ? <Button variant="contained" onClick={handleClickAdd}>
            Add entry
         </Button>
            : null;
   ...
   const actionButtons =
      type === "edit" ?
         <DialogActions>
            ...
            <Button onClick={handleUpdate} variant="contained">{editText}</Button>                       
         </DialogActions>
         : type === "add" ?
            <DialogActions>
               <Button onClick={handleClose}>Cancel</Button>
